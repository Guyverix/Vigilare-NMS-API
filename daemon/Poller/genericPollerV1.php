...
// All the heavy lifting should be done here
...
/*
  ...
  Do it before the daemonFunctions so they can also log the details of what they
  are doing.  Dammit.  Cant do this because order-of-operations
*/
if ( ! isset($logger)) {
