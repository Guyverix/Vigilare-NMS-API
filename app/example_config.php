...
/*
  API VARIBLES
*/
$apiUrl ='https://???';      // for responding with things like images
$apiHost="https://??";      // Poller default and independent of $apiUrl

$apiPort='8002';                                      // Used to craft URLs correctly when non-standart ports in play
$apiKey ='???';      // Create with uuidgen :) lives in settings.php as array.  This is for daemons or custom script auth
...
/*
  ...
  If you are using a proxy, put the proxy URL here, not
  the hostname URL.
*/
$frontendUrl='https://???';
...
/*
  completely unused ATM
  useful for reporting and to keep from beating up the db on SELECTs
  This will be investigated for V2, likely not needed soon

$dbReplica='192.168.15.251';
$dbReplicaPort='3306';
...
$pollerName='???';          // Define here, so remote collectors have one spot only to change (unsupported in V1)
...
$emailAuthType='PLAIN';
$emailFromAddress='nms@somedomain.com';
$emailFromName='NMS Mailer';
$emailReplyToAddress='noreply@somedomain.com';
$emailReplyToName='Unmonitored Address';

$emailAdmin='admin@somedomain.com';  // basically unused currently
$emailLogin='admin';
$emailPassword='fakePass';
$emailSmtp='smtp.somedomain.com';
$emailPort='25';

/*
  Email parsing for things like events from email
...
$emailRecieveHost='imap.somedomain.com';
*/

/*
  AUTHENTICATION VARIABLES
                        USER AUTH (TODO beyond daatabase)
...
$authTypes=['database','ldap','ad','sso','other','none'];  // only db currently supported
...
$ticketingSystemUrl='http://ticketing.somedomain.com:9001/tickets';        // Used for POST in creating ticket.  Leverage with templates
...
$graphiteUrl='https://graphite.somedomain.com';
$graphitePort=443;
