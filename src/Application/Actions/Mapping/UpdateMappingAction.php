...
class UpdateMappingAction extends MappingAction
{
  /**
   * {@inheritdoc}
   */
  protected function action(): Response {
    ...
    */
    ...
    if (! isset($data['oid'])) {
      ...
      $mapping="OID value is manditory to update an existing oid mapping, DUH!  Please play again.";
      $this->logger->error("Attempted to update an oid mapping without an oid value set");
    }
    /*
    ...
    */
    ...
    if ( $responseCode !== 405) {
      ...
      $mapping = $this->mappingRepository->updateMapping($data);
      $this->logger->info("Changed or updated trap mapping for oid " . $data['oid'] );
