...
CREATE TABLE `Device` (
  ...
  KEY `id` (`id`,`hostname`)
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Start of the tree is the host itself';
...
--
-- Table structure for table `__GraphiteMap`
--

DROP TABLE IF EXISTS `__GraphiteMap`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `__GraphiteMap` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `activeMonitors` (
  ...
  `alarm` text COMMENT 'define any thresholds we check or we ignore\r\n',
...
-- Dump completed on 2024-12-27 11:48:01
