<?php
  ...
  */
    ...
    foreach ($dataToBeInserted as $k => $v) {
      ...
      switch ($k) {
        ...
        case "iso.OIDTABLE.4.$SOMENAME":
          ...
          $clean[$SOMENAME]['dataToBeInserted'][] = array( 'name' => "NAME3", 'value' => "$v", 'type' => 'COUNTER');
          break;
  ...
  foreach ($mapped as $someNames) {
    ...
    $rrdRootFile=$hostname . "/snmp/thing/space/" . $someNames['UNIQUE_METRIC_NAME'] . "_32.rrd";  // really int values, but JIC I find some good 64 counters dont want to recode
