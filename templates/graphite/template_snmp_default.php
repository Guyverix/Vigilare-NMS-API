  ...
  */
  ...
  foreach ($metricNames as $key => $value) {
    ...
    */
    ...
    $renderUrl[] = $graphiteUrl . ":" . $graphitePort . "/render/?" . $renderBegin . $renderEnd . $returnFormat;

    /*
       Default graph is a catchall!  Dont get fancy or stuff will break!
    */
