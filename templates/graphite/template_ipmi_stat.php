<?php
/*
  This template is created to return Graphite data and formatting to
  render graphs specifically for ipmi.stat data.
...
*/
  ...
  */
  ...
  case "raw":
    ...
    break;
  default:
    $returnFormat='&areaMode=all';  // breaking standards for this specific template so we can get area coverage
    break;
  }
  ...
  /*
     Disable object when testing.  Enable when correct
  */
  $this->returnArrayValues=$renderUrl;
  return $this->returnArrayValues;
  //  echo print_r($renderUrl, true);
  //  echo var_dump($renderUrl);
?>
