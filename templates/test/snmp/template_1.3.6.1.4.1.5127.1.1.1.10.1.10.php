    ...
    foreach ($dataToBeInserted as $k => $v) {
      switch ($k) {
        case (strpos($k, "3.6.1.4.1.5127.1.1.1.10.1.10.1.2.$driveNumber") !== false):
          $settings['Drive_' . $driveNumber]['Manufacturer']=$v;
          break;
        case (strpos($k, "3.6.1.4.1.5127.1.1.1.10.1.10.1.3.$driveNumber") !== false):
          $settings['Drive_' . $driveNumber]['Serial Number']=$v;
          break;
        case (strpos($k, "3.6.1.4.1.5127.1.1.1.10.1.10.1.4.$driveNumber") !== false):
          $settings['Drive_' . $driveNumber]['Secondary Number']=$v;
          break;
        case (strpos($k, "3.6.1.4.1.5127.1.1.1.10.1.10.1.5.$driveNumber") !== false):
          $settings['Drive_' . $driveNumber]['Drive Temp']=$v;
          break;
        case (strpos($k, "3.6.1.4.1.5127.1.1.1.10.1.10.1.6.$driveNumber") !== false):
          $settings['Drive_' . $driveNumber]['Capacity']=$v;
          break;
      }
    }
  }
